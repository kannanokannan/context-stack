...
| Project | Kind | Question it answers | Status |
|---------|------|-------------------|--------|
| [ContextOps](https://github.com/kannanokannan/ContextOps) | Specification | How does an org govern its AI context? | v0.1 active |
| [ContextBoundary](https://github.com/kannanokannan/ContextBoundary) | Specification | Where is data allowed to go? | v0.1 active |
| [contextboundary-gw](https://github.com/kannanokannan/contextboundary-gw) | Reference implementation | Does a gateway enforce it deterministically? | v1.1.0 |
| [Sthala](https://github.com/kannanokannan/Sthala) | Reference implementation | Where does the AI actually run? | v0.1 Alpha |
| [Griha](https://github.com/kannanokannan/Griha) | Reference implementation | How do the stack principles appear in a working system? | Proof of concept |
